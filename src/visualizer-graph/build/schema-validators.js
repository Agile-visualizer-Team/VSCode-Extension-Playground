...
exports.validateAnswerSetsSchema = exports.validateTemplateSchema = void 0;
...
exports.validateTemplateSchema = new ajv_1.default({ schemas: [COLOR_SCHEMA], useDefaults: true }).compile(TEMPLATE_SCHEMA);
exports.validateAnswerSetsSchema = new ajv_1.default().compile(ANSWER_SETS_SCHEMA);
