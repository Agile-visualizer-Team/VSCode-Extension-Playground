...
var MatrixImagesCreator = /** @class */ (function () {
     ...
     */
    MatrixImagesCreator.prototype.read_commands_and_run = function () {
        var _this = this;
        /* A command line interface for the program. It is using the yargs library to parse the
        command line arguments. */
        yargs.command('fromfile', 'generate the matrix images from files', function (yargs) {
            return yargs
                .option('template', {
            ...
            var images_directory = argv.imgDir;
            _this.setup_and_run_script(config_file, images_directory, answer_set_json, '');
        })
            .command('fromstr', 'generate the matrix images from json string inputs', function (yargs) {
            return yargs
                .option('template', {
                describe: 'the input json template file path',
                type: 'string',
