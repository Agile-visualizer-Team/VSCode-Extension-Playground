...
describe('create_table_html method tests', () => { // the tests container
...
describe('retrieve_matrix_cell_as_tuple method tests', () => { // the tests container
...
describe('fill_matrix_with_values method tests', () => { // the tests container
...
describe('create_html_to_convert_in_image method tests', () => { // the tests container
...
describe('init_matrix_rows_and_columns method tests', () => { // the tests container
...
describe('create_html_table_for_mapped_atom method tests', () => { // the tests container
...
describe('create_matrix_from_atoms_list method tests', () => { // the tests container
...
describe('maxNumOfAnswerSetToConvert method tests', () => { // the tests container
    ...
    let result:string = matrix_creator.maxNumOfAnswerSetToConvert()
...
describe('run_script method tests', () => { // the tests container
    ...
    it('Dark mode colors must be setted if dark mode is enabled', () => {
        ...
        let expected_value = 'html{background-color: #101010;color: #111111;'.trim().replace(/\s+/g, '');
