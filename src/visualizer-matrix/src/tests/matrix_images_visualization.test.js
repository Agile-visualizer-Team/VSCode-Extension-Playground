...
let matrix_images_creator = new MatrixImagesCreator();
...
`);
describe('[matrix images creator] create_table_html method tests', () => {
    beforeEach(() => {
        // runs before each test in this block
        matrix_images_creator = new MatrixImagesCreator();
        matrix_images_creator.config_file = config_file;
    });
    it('create_table_html must create a right html table when we pass a list of right formed atoms but without images', () => {
        //given a matrix  
        let matrix = [['pos00', 'pos01'], ['pos10', 'pos11']];
        //given a mapped atom 'cell'
        let mapped_atom = 'cell';
        let expected_value = `<table><thead><tr class="titolo"><th>Visualization</th></tr></thead><tbody><tr></tr><tr></tr></tbody></table>`;
    ...
    it('create_table_html must create an empty html table when we pass a list of length 0', () => {
        ...
        //given a mapped atom 'cell'
        let mapped_atom = 'cell';
        let expected_value = `<table><thead><tr class="titolo"><th>Visualization</th></tr></thead><tbody><tr></tr></tbody></table><strong>There aren not atoms with values you mapped as images</strong>`;
        //when we call the function create_table_html
        let result = matrix_images_creator.create_table_html(matrix, mapped_atom);
        //then we expect the result to be equal to the expected value
        expect(result).to.eql(expected_value);
...
describe('[matrix images creator] retrieve_matrix_cell_as_tuple method tests', () => {
    beforeEach(() => {
        // runs before each test in this block
        matrix_images_creator = new MatrixImagesCreator();
        matrix_images_creator.config_file = config_file;
...
describe('[matrix images creator] fill_matrix_with_values method tests', () => {
    beforeEach(() => {
        // runs before each test in this block
        matrix_images_creator = new MatrixImagesCreator();
        matrix_images_creator.config_file = config_file;
    ...
    it('fill_matrix_with_values must modify the correct cells of the matrix if all is correct', () => {
        //given an a splitted atoms matrix with no rows  
        let atoms_splitted_matrix = [['0', '0', 'hello']];
        //given an a matrix with the correct sizes to fill 
        let matrix = [['Not defined']];
        let expected_value = 'hello_value';
        //when we call the function fill_matrix_with_values
        let result = matrix_images_creator.fill_matrix_with_values(atoms_splitted_matrix, matrix);
        //then we expect the result to be equal to the expected value
...
describe('[matrix images creator] create_html_to_convert_in_image method tests', () => {
    beforeEach(() => {
        // runs before each test in this block
        matrix_images_creator = new MatrixImagesCreator();
        matrix_images_creator.config_file = config_file;
    ...
    it('create_html_to_convert_in_image have to return the right string when is called', () => {
        ...
        let result = matrix_images_creator.create_html_to_convert_in_image('string');
        //then we expect the result to be equal to the expected value
        expect(result.includes(expected_value)).to.eql(true);
    });
});
describe('[matrix images creator] init_matrix_rows_and_columns method tests', () => {
    beforeEach(() => {
        // runs before each test in this block
        matrix_images_creator = new MatrixImagesCreator();
        matrix_images_creator.config_file = config_file;
    ...
    it('init_matrix_rows_and_columns could create a matrix with all cells setted to "undefined"', () => {
...
describe('[matrix images creator] create_html_table_for_mapped_atom method tests', () => {
    beforeEach(() => {
        // runs before each test in this block
        matrix_images_creator = new MatrixImagesCreator();
        matrix_images_creator.config_file = config_file;
    ...
    it('create_html_table_for_mapped_atom has to return have almost one image as true if all is correct', () => {
        let atoms_list = ['cell(0,0,hello)'];
        let mapped_atom = 'cell';
        let table_html = '';
        let expected_value = true;
        //when we call the function init_matrix_rows_and_columns
        matrix_images_creator.create_html_table_for_mapped_atom(atoms_list, mapped_atom, table_html);
        let result = matrix_images_creator.almost_one_image_printed;
        //then we expect the result to be equal to the expected value
        expect(result).to.eql(expected_value);
    });
...
describe('[matrix images creator] create_matrix_from_atoms_list method tests', () => {
    beforeEach(() => {
        // runs before each test in this block
        matrix_images_creator = new MatrixImagesCreator();
        matrix_images_creator.config_file = config_file;
...
describe('[matrix images creator] maxNumOfAnswerSetToConvert method tests', () => {
    beforeEach(() => {
        // runs before each test in this block
        matrix_images_creator = new MatrixImagesCreator();
        matrix_images_creator.config_file = config_file;
    ...
    it('maxNumOfAnswerSetToConvert has return the right value', () => {
        ...
        let result = matrix_images_creator.maxNumOfAnswerSetToConvert();
        expect(result).to.eql(2);
        sinon.restore();
    });
});
describe('[matrix images creator] run_script method tests', () => {
    beforeEach(() => {
        // runs before each test in this block
        matrix_images_creator = new MatrixImagesCreator();
        matrix_images_creator.config_file = config_file;
